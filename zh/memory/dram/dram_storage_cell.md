...
1. 外界的逻辑电平与 Storage Capacitor 的电平不匹配  
  由于 Bitline 的电容值比 Storage Capacitor 要大的多，当 Access Transistor 导通后，如果 Storage Capacitor 存储的信息为 1 时，Bitline 上呈现的电压通常是要低于 Vcc。外界电路无法直接通过 Bitline 来读取 Storage Capacitor 所存储的信息。
