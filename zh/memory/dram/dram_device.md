...
> **Internal rate (MHz)** 则是内部 Memory Array 操作的的频率。由于 SDRAM 采用电容作为存储介质，电容由于工艺和物理特性的限制，充放电的时间没有办法进一步的缩短，所以内部 Memory Array 的操作频率也受到了限制，目前最高能到 266.67 MHz，这也是 SDR 到 DDR 采用 Prefetch 架构的主要原因。
