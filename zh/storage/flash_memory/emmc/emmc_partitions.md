...
在 Boot State 下，如果有配置 BOOT_ACK，eMMC 会先发送 “010” 的 ACK 包，接着 eMMC 会将最大为 128Kbytes x BOOT_SIZE_MULT 的 Boot Data 发送给 Host。传输过程中，Host 可以通过拉高 CMD (Original Boot)，或者发送 Reset 命令 (Alternative Boot) 中断 eMMC，完成 Boot Data 传输。
