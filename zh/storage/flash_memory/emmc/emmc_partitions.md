...
1. CMD 信号保持低电平超过 74 个时钟周期，会触发 Normal boot operation。
2. 在 74 个时钟周期后，在 CMD 信号首次拉低或者 Host 发送 CMD1 之前，Host 发送参数为 0xFFFFFFFA 的 COM0，会触发 Alternative boot operation。
